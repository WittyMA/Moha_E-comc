...
const moreInfo = () => {
  ...
  p1.innerText = "Company Details:";
  let p2 = document.createElement("p");
  p2.innerText = "Country Of Origin - GHANA";
  let p3 = document.createElement("p");
  p3.innerText = "Imported By - WittyMA";
  let p4 = document.createElement("p");
  p4.innerText = "Net Quantity: 1 N";
  let p5 = document.createElement("p");
  p5.innerText = "Contact customer care on ...";
...
const productSpecifications = () => {
  ...
  td2tr6.innerText = "Modern Bottle";
  ...
  td1tr4.innerText = "BOTTLE TYPE";
  td2tr4 = document.createElement("td");
  td2tr4.innerText = "Gold Bottle";
...
const display = (products) => {
  ...
  let price = document.createElement("h3");
  price.innerText = "PRICE GH₵" + products.Price;
...
btn.addEventListener("click", function () {
  ...
  cart.push(products);
  a.innerHTML = `<img src="img/cart.svg" alt="Cart Icon" style="width: 3vw; height: 3vh; vertical-align: middle;">${cart.length}`;
